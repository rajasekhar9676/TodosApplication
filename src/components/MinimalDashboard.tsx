    ...
    <div className="max-w-7xl mx-auto p-6 space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <div className="bg-gray-50 rounded-lg p-4">
          <p className="text-sm text-gray-700">
            <strong>User ID:</strong> {user?.uid || 'Not logged in'}<br/>
            <strong>User Email:</strong> {user?.email || 'No email'}<br/>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        <div className="flex">
          ...
          <div className="ml-3">
            <h3 className="text-sm font-medium text-blue-800">Dashboard Status</h3>
            <div className="mt-2 text-sm text-blue-700">
              <p>This is a minimal dashboard to avoid complex data fetching issues. Use the Debug page to investigate problems.</p>
            </div>
          </div>
        </div>
      </div>
